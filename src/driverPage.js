  ...
  >
     ...
     <Typography
          ...
          <Typography variant="body1"
            component="div" sx={{ fontWeight: "bold" }}> Nombre</Typography>
          <Typography variant="body1"
            component="div"> Jose Polo</Typography>
          <Typography component="div" sx={{ fontWeight: "bold" }}> cc/Nit</Typography>
          <Typography variant="body1"
...
>
  <List>
    ...
    <ListItem button onClick={() => handleListItemClick("requestPickup")}>
      <ListItemText primary="Solicitudes Asignadas" />
    </ListItem>
    <ListItem button onClick={() => handleListItemClick("history")}>
      <ListItemText primary="Historial" />
    </ListItem>
    <ListItem button onClick={() => handleListItemClick("rute")}>
